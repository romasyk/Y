            ...
            <div class="col-md-12 chat-header">
                <div class="row header-one text-white p-1">
                    <div class="col-md-6 name pl-2">
                        ...
                        <#if names??><h6 class="ml-1 mb-0">${names[3]} ${names[4]}</h6></#if>
                    </div>
                                    ...
                                    <#if data??>
                                        <#if data[0] == message.senderId>
                                            <li class="send-msg float-right mb-2">
                                                ...
                                                <span class="send-msg-time">${message.dataTime}</span>
                                            </li>
                                        </#if>
                                        <#if data[1] == message.senderId>
                                            <li class="receive-msg float-left mb-2">
                                                <div class="sender-img">
                                                    <img src=${names[5]} class="float-left">
                                                </div>
                                                <div class="receive-msg-desc float-left ml-2">
                                                    <p class="bg-white m-0 pt-1 pb-1 pl-2 pr-2 rounded">
                                                        ${message.text}
                                                    </p>
                                                    <span class="receive-msg-time">${names[3]}, ${message.dataTime}</span>
                                                </div>
                                            </li>
                                        </#if>
                                    </#if>
