...
<form class="form-signin" action="/users" method="POST">
    <img class="mb-4" src="https://banner2.cleanpng.com/20180408/ice/kisspng-y-alphabet-letter-ue-a-letter-5ac9cc25a7b551.223091351523174437687.jpg" alt="" width="72" height="72">
